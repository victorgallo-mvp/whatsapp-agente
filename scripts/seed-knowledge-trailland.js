...
const entries = [
  ...
  {
    source_type: "ficha_tecnica",
    context: `mxf 300 tsx-r tsxr competição 2 tempos ${CTX}`,
    content: "Ficha técnica MXF 300 TSX-R (2 tempos), a versão de competição da 300 TSX. Motor: 2 tempos, monocilíndrico, refrigerado a água, com válvula de escape mecânica. Cilindrada: 300 cc. Alimentação: carburador 36 mm com Power Jet. Transmissão: corrente DID X-Ring 520, pinhão 13 dentes, coroa 50 dentes. Marchas: 6. Embreagem: multidiscos banhados a óleo. Partida: elétrica. Quadro: aço liga cromo-molibdênio de alta resistência. Suspensão dianteira: Kayaba 48 mm de longo curso (300 mm), totalmente ajustável em compressão e retorno, tubos com tratamento DLC (Diamond Like Carbon). Suspensão traseira: SZC com regulagem de pré-carga da mola e ajustes de compressão (rápida e lenta) e retorno (300 mm). Freio dianteiro: hidráulico a disco ventilado de 260 mm, Taisko Japan. Freio traseiro: hidráulico a disco ventilado de 220 mm, Taisko Japan. Roda dianteira: aro Excell Takasago 21x1,60, cubo em alumínio CNC, pneu Kenda 90/90-21. Roda traseira: aro Excell Takasago 18x2,15, cubo em alumínio CNC, pneu Kenda 140/80-18. Escapamento: MXF Pro-Exhaust Titanium com curva de escape em inox. Capacidade do tanque: 8 litros. Altura do assento: 950 mm. Altura do solo: 350 mm. Entre-eixos: 1.500 mm. Peso: 106 kg. Dimensões: 2.180 x 830 x 1.300 mm. A ficha oficial deste modelo não informa potência nem torque — se perguntarem, confirme com o time em vez de estimar.",
    metadata: { escopo: "MXF 300 TSX-R", termos: ["300 tsx-r", "300 tsxr", "tsx-r", "tsxr"] },
  },
  {
    source_type: "ficha_tecnica",
